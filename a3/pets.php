...
<div class="container">
    <main>
        ...
        <p>
            ...
            ORGANIZATION
            OFFERS A RANGE OF SERVICES, INCLUDING ADOPTION COUNSELING, PET EDUCATION, AND COMMUNITY SUPPORT PROGRAMS,
        ...
        <table class="pet-table">
            ...
            <tbody>
                ...
                $sql = "SELECT petid, petname, type, age, location FROM pets"; // Include petid in the query
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        echo "<tr>";
                        // Create a hyperlink for the pet name that directs to details.php
                        echo "<td><a href='details.php?pet_id=" . htmlspecialchars($row['petid']) . "'>" . htmlspecialchars($row['petname']) . "</a></td>";
